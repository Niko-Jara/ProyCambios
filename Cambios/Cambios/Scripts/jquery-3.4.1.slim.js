...
function createDisabledPseudo( disabled ) {
	...
	// Known :disabled false positives: fieldset[disabled] > label:nth-of-type(n+2) :can-disable
	return function( elem ) {
		...
		// Some victims get caught in our net (label, label, menu, track), but it shouldn't
